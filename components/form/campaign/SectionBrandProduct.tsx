  ...
  return (
    <section className="bg-white rounded-xl border border-gray-200 p-6 space-y-4">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <h2 className="text-base font-semibold text-gray-900">Brand / Product</h2>
          <p className="text-xs text-gray-500">Identify the brand or product this campaign will promote.</p>
        </div>
      </div>

      {/* Fields */}
      <div>
        <Label htmlFor="brand-name" className="text-sm font-medium text-gray-700 mb-1.5 block">
