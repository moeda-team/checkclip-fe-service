    ...
    <div className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-lg shadow border">
          <div className="text-sm font-semibold text-gray-900 py-4 px-4 b-4 border-b">
            Revenue Trend
          </div>
          ...
          <div className="space-y-2 px-4 py-4 max-h-96 overflow-auto">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-gray-500">
                  Created a new deal worth ¥50,000
                </p>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-gray-500">
                  Scheduled a demo with Tech Corp
                </p>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-gray-500">
                  Closed the Cloud Migration project
                </p>
          ...
          <div className="space-y-2 px-4 py-4 max-h-96 overflow-auto">
            ...
            <div className="border border-gray-200 rounded-lg p-4">
              <div className="flex items-center gap-3 mb-3">
                ...
                <span className="bg-orange-100 text-orange-700 text-xs px-4 py-1 rounded-full">
                  Review
                </span>
              </div>
              <div className="flex items-center justify-between text-xs text-gray-600 mb-2">
            ...
            <div className="border border-gray-200 rounded-lg p-4">
              <div className="flex items-center gap-3 mb-3">
                <div className="w-10 h-10 bg-primary-100 rounded-lg flex items-center justify-center">
                  <span className="text-primary-600 font-bold text-sm">IL</span>
                </div>
                <div className="flex-1">
                  <h4 className="text-sm font-medium text-gray-900">
                    Innovate Labs
                ...
                <span className="bg-primary-100 text-primary-700 text-xs px-4 py-1 rounded-full">
                  Discovery
                </span>
              </div>
              <div className="flex items-center justify-between text-xs text-gray-600 mb-2">
